...
void ui_main(void)
{
    ...
    lv_obj_set_style_text_font(file_label, &lv_font_montserrat_16, 0);
    lv_obj_align(file_label, LV_ALIGN_TOP_MID, 0, 20);
    ...
    lv_obj_align(file_label_title, LV_ALIGN_TOP_MID, 0, 0);
    
    /* Create Play button */
    play_btn = lv_btn_create(lv_scr_act());
    lv_obj_set_size(play_btn, 80, 40);
    ...
    lv_obj_set_size(skip_btn, 80, 40);
    lv_obj_align(skip_btn, LV_ALIGN_BOTTOM_LEFT, 120, -20);
    ...
    lv_obj_set_size(vol_up_btn, 80, 40);
    lv_obj_align(vol_up_btn, LV_ALIGN_BOTTOM_RIGHT, -120, -20);
    ...
    lv_obj_set_size(vol_down_btn, 80, 40);
    lv_obj_align(vol_down_btn, LV_ALIGN_BOTTOM_RIGHT, -20, -20);
